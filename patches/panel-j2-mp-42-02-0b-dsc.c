...
/*
 * CSOT J2 MP 42 02 0B 6.67" 1080x2340 DSC AMOLED panel driver.
 *
 * Panel used on Xiaomi Mi 10S (thyme) and Mi 10 (umi), SM8250.
 * Derived from vendor dsi-panel-j2-mp-42-02-0b-dsc-cmd.dtsi via
 * linux-mdss-dsi-panel-driver-generator; DCS init sequence retained
 * verbatim from vendor. Probe/callbacks rewritten against Linux 6.13
 * drm_panel / mipi_dsi API (structure modelled after panel-lg-sw43408.c).
 */
...
MODULE_AUTHOR("Xiaomi Mi 10S (thyme) porting");
MODULE_DESCRIPTION("DRM driver for CSOT j2-mp-42-02-0b-dsc DSC AMOLED panel");
MODULE_LICENSE("GPL");